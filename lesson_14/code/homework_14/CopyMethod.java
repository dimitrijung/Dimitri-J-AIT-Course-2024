...
public class CopyMethod {
    ...
    public static int[] copyOfArray (int [] array, int n){
        ...
        for (int i = 0; i< array.length; i++){     // создаем цыкл и говорим ему условие "i< array.length && i < n" работай до тех пор пока  "i" меньше длинны старого цикла, либо "i" меньше длинны [n] нового цикла.
