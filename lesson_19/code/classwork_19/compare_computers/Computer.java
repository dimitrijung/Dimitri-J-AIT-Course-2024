...
private double price;
    ...
    public boolean equals(Object o) {
        if (this == o) return true; // сравниваем обьект сам с собой, возвращаем true
        if (!(o instanceof Computer computer)) return false; // это обьект не из класса Computer, возвращаем false
